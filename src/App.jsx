...
const days = [
  ...
  ['02','ВНУТРИ ВУЛКАНА','Jameos del Agua, Cueva de los Verdes, Jardín de Cactus и Mirador del Río. День Сезара Манрике, лавовых тоннелей и первого взгляда на La Graciosa с высоты.'],
...
const chapters = [
  {key:'manrique', kicker:'CÉSAR MANRIQUE', title:'ЧЕЛОВЕК, КОТОРЫЙ\nПРИДУМАЛ ОСТРОВ', text:'Художник, архитектор и главный визуальный автор Лансароте. Его пространства соединяют лаву, белые стены, воду и растения так естественно, будто остров сам решил заняться дизайном.', image:'/images/manrique.png'},
